...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2)
				...
				.select()
				.apis(RequestHandlerSelectors.basePackage("com.databuilder.com.br.escalafacil.resources"))
	...
	private ApiInfo apiInfo() {
		return new ApiInfo("API do Software EscalaFacil",
				"Esta API é utilizada para geração de escalas Diversas", 
				"Versão 1.0",
				"https://www.databuilder.com.br/escalafacil/terms",
				new Contact("Wendell Clive", "www.databuilder.com.br", "wendell.clive@databuilder.com.br"),
				"Permitido uso para publico em Geral", 
				"https://www.databuilder.com.br/escalafacil/terms", 
